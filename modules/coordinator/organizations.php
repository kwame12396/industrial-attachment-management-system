<?php
// modules/coordinator/organizations.php - View and manage organizations
...
if (isset($_GET['delete'])) {
    ...
    // Delete related industrial supervisors first
    $conn->query("DELETE FROM industrial_supervisors WHERE organization_id = $org_id");
    $conn->query("DELETE FROM organizations WHERE id = $org_id");
    $_SESSION['success'] = "Organization deleted.";
    redirect('modules/coordinator/organizations.php');
}
...
<head>
    ...
    <title>Manage Organizations - IAMS</title>
...
<body>
    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:inline-block;vertical-align:middle;flex-shrink:0;margin-right:0.5rem;"><path fill="none" stroke-linecap="round" stroke-linejoin="round" d="M8.461 4.75V1.594c0-.56-.454-1.015-1.015-1.015h-4.79c-.562 0-1.016.454-1.016 1.015v11.827m-1.121 0h4.968M1.64 3.187H4.1M1.64 5.75h3.847m4.993 4.282a1.75 1.75 0 1 0 0-3.5a1.75 1.75 0 0 0 0 3.5m-3.001 3.389a3.04 3.04 0 0 1 .39-1.46a3.03 3.03 0 0 1 2.611-1.537a3.03 3.03 0 0 1 2.612 1.538c.25.445.385.947.39 1.459"/></svg>Organizations</h3>
            <a href="../../register_organization.php" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:inline-block;vertical-align:middle;flex-shrink:0;margin-right:0.5rem;"><path fill="none" stroke-linecap="round" stroke-linejoin="round" d="M7 .5v13M.5 6.96h13"/></svg>Add Organization</a>
        </div>
        
        <?php displayMessage(); ?>
        
        <div class="card">
            <div class="card-header bg-white"><h5>Host Organizations</h5></div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr><th>Name</th><th>Location</th><th>Contact Email</th><th>Capacity</th><th>Allocated</th><th>Actions</th></tr>
                        </thead>
                        <tbody>
