<?php
// modules/coordinator/view_final_reports.php
...
<head>
    ...
    <title>Final Reports - Coordinator</title>
...
<body>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header bg-white"><h5>All Submitted Reports</h5></div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead>
                            <tr><th>Student ID</th><th>Student Name</th><th>Original Filename</th><th>Submission Date</th><th>Download</th></tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="../../assets/uploads/reports/<?php echo $row['file_path']; ?>" class="btn btn-sm btn-primary" download><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:inline-block;vertical-align:middle;flex-shrink:0;"><g fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M7 13.5a6.5 6.5 0 1 0 0-13a6.5 6.5 0 0 0 0 13M5.5 10h3"/><path d="M7 10V6.5H6m1-2.25a.25.25 0 0 1 0-.5m0 .5a.25.25 0 0 0 0-.5"/></g></svg> Download</a></td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
